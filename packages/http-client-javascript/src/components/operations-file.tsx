...
import { getContextDeclarationRefkey } from "./client-context.js";
...
export function OperationsFile(props: OperationsFileProps) {
  ...
  const client = $.client.get(props.service.type)!;
  ...
  return <ts.SourceFile path={props.path}>
      {mapJoin(props.operations, (o) => {
        ...
        const signatureParams = {  "client": <ts.Reference refkey={getContextDeclarationRefkey(client)}/>};
        return (
