...
export function EncodeUint8Array(): string {
  ...
  return <ts.FunctionDeclaration name="encodeUint8Array" parameters={{value: {type: "Uint8Array | undefined", refkey: valueRef,}, encoding: {type: "BufferEncoding", refkey: encodingRef}}} returnType="string | undefined">
   {ay.code`
      if (!${valueRef}) {
        return undefined;
      }
...
export function DecodeBase64(): string {
  const valueRef = ay.refkey();
  return <ts.FunctionDeclaration name="decodeBase64"  parameters={{value: {type: "string", refkey: valueRef}}} returnType="Uint8Array | undefined">
    {ay.code` 
      if(!${valueRef}) {
        return undefined;
      }
