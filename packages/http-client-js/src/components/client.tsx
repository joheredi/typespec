...
export function Client(props: ClientProps) {
  ...
  return <ay.For each={topLevel} hardline>
    {(client) => {
...
export function ClientClass(props: ClientClassProps) {
  ...
  return <ClassDeclaration export name={clientName} refkey={clientClassRef}>
    <ts.ClassField name="context" jsPrivate refkey={contextMemberRef} type={contextDeclarationRef} />;<br />
    ...
    <ay.For each={operations} hardline joiner=";">
      {(op) => {
        ...
        return <ClassMethod async type={op.httpOperation.operation} parameters={parameters} returnType={null} parametersMode="replace">
            return <ts.FunctionCallExpression target={ay.refkey(op.httpOperation.operation)} args={[contextMemberRef, ...args]}/>;
        </ClassMethod>
      }}
    </ay.For>
  </ClassDeclaration>;
...
function ClientConstructor(props: ClientConstructorProps) {
  ...
  return <ts.ClassMethod name="constructor" parameters={constructorParameters}>
    {clientContextFieldRef} = <ts.FunctionCallExpression target={clientContextFactoryRef}  args={args}/>;<br />
