...
export function jsonFishToTransportTransform(input_?: Fish): any {
  if (!input_) {
    return input_ as any;
  }
...
export function jsonSharkToTransportTransform(input_?: Shark): any {
  if (!input_) {
    return input_ as any;
  }
...
export function jsonSawSharkToTransportTransform(input_?: SawShark): any {
  if (!input_) {
    return input_ as any;
  }
...
export function jsonGoblinSharkToTransportTransform(input_?: GoblinShark): any {
  if (!input_) {
    return input_ as any;
  }
...
export function jsonSalmonToTransportTransform(input_?: Salmon): any {
  if (!input_) {
    return input_ as any;
  }
